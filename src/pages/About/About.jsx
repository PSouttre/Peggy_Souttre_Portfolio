    ...
    return (
        <MainLayout>
            ...
            <div className="container__collapse">
                <Collapse title="Formation Developpeuse" content="Formation OpenClassRooms 2023/2024  Développeur Web. Diplôme de niveau 5 (bac + 2). Compétences acquises : construire un site web responsive et dynamique, créer des API et des bases de données, optimiser les performances et réaliser la maintenance de sites web déjà existants, gérer un projet web de A à Z.
